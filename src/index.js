...
server.tool(
  ...
  'Download a TikTok video without watermark. Returns HD video URL ready for download. Example: download_video_no_watermark("https://www.tiktok.com/@user/video/1234567890")',
  {
...
server.tool(
  'get_video_info',
  'Get full metadata for a TikTok video including stats, author info, and music. Example: get_video_info("https://www.tiktok.com/@charlidamelio/video/1234567890")',
  {
...
server.tool(
  'get_video_metadata',
  'Get raw technical metadata for a TikTok video including all available API fields. Useful for debugging or accessing fields not in get_video_info.',
  {
    tiktok_url: z.string().url().describe('Full TikTok video URL')
  },
  async ({ tiktok_url }) => {
...
server.tool(
  'get_user_profile',
  'Get a TikTok user\'s profile information including follower count, bio, and verification status. Example: get_user_profile("charlidamelio")',
  {
...
server.tool(
  'get_user_videos',
  'Get recent videos from a TikTok user\'s profile. Returns video list with stats and download URLs. Example: get_user_videos("khaby.lame", 20)',
  {
...
server.tool(
  'get_user_followers',
  'Get follower list for a TikTok user. Example: get_user_followers("mrbeast", 50)',
  {
    username: z.string().min(1).describe('TikTok username without @ symbol'),
...
server.tool(
  'get_user_following',
  'Get accounts that a TikTok user is following. Example: get_user_following("addisonre", 50)',
  {
    username: z.string().min(1).describe('TikTok username without @ symbol'),
...
server.tool(
  'get_trending_videos',
  'Get currently trending TikTok videos. Returns top videos with engagement stats. Example: get_trending_videos("US", 20)',
  {
...
server.tool(
  ...
  'Get currently trending hashtags on TikTok. Example: get_trending_hashtags("US")',
  {
...
server.tool(
  'get_trending_sounds',
  'Get currently trending sounds and music on TikTok. Useful for identifying audio trends for content creation. Example: get_trending_sounds("US")',
  {
...
server.tool(
  'search_videos',
  'Search TikTok for videos matching a keyword or phrase. Example: search_videos("morning routine", 20)',
  {
...
server.tool(
  'search_users',
  'Search TikTok for users matching a name or keyword. Example: search_users("fitness coach", 20)',
  {
...
server.tool(
  'search_hashtags',
  'Search TikTok for hashtags matching a keyword. Find related hashtags for content strategy. Example: search_hashtags("fitness")',
  {
...
server.tool(
  'get_video_comments',
  'Get comments on a TikTok video. Example: get_video_comments("7123456789012345678", 20)',
  {
...
server.tool(
  'get_video_likes',
  'Get users who liked a TikTok video. Example: get_video_likes("7123456789012345678", 50)',
  {
...
server.tool(
  ...
  'Get audience demographic insights for a TikTok creator based on follower analysis and engagement patterns. Example: get_audience_insights("charlidamelio")',
  {
    username: z.string().min(1).describe('TikTok username without @ symbol'),
